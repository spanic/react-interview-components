...
- if `toggleOnly == true`, user can add or remove only single instance of the Offer by pressing the corresponding button
- otherwise, user can add same Offer multiple times by pressing counter buttons or by entering quantity manually using the input
